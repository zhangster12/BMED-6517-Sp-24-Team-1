...
# difference between different stimulus

# Note) diff stims and siff features have different lengths each - cannot form a multi-dim matrix - made list

# interpolation, resample, mean (1 s)
